...
enum MeetingCategory {
  ...
  billiards('당구', Icons.sports_handball_outlined, AppColors.bgInfo, AppColors.textInfo),
  bowling('볼링', Icons.sports_handball, AppColors.bgInfo, AppColors.textInfo),
  climbing('클라이밍', Icons.landscape, AppColors.bgSuccess, AppColors.textSuccess),
  hiking('등산', Icons.terrain, AppColors.bgSuccess, AppColors.textSuccess),
  running('러닝', Icons.directions_run, AppColors.bgSuccess, AppColors.textSuccess),
  movie('영화', Icons.movie_outlined, AppColors.bgInfo, AppColors.textInfo),
